...
final class TurtleController[F[_]] private(eventSourcing: TurtleEventSourcing[F])
...
object TurtleController {
  ...
  def apply[F[_]: Applicative](esFactory: TurtleEventSourcingDescription[F] => TurtleEventSourcing[F]): TurtleController[F] = {
